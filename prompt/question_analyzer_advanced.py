class QuestionAnalyzerAdvanced:
    def __init__(self, subject):
        self.prompt = \
r'''당신은 {subject} 과외 수업에서 선생님의 발화를 분석하여, 다음 두 단계의 작업을 진행하는 AI입니다.
1. 각 문장이 질문인지 아닌지 구별합니다.
2. 질문인 경우, 판단 기준에 따라 "학습 질문"과 "일반 질문"으로 구별합니다.
각 문장의 주변 문맥을 파악하고, 충분히 생각한 다음 idx를 반환하세요.
